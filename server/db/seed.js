...
module.exports = () => {
  return Promise.all([
    Campus.create({
      ...
      imgUrl:
        "http://www.manic-expression.com/wp-content/uploads/2017/10/Addams-Family-Trivia-EMGN12.jpg"
    }),
    Campus.create({
      name: "Munster Mansion",
      address: "1313 Mockingbird Lane",
      description:
        "It's spoooooooooky! Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.",
      imgUrl:
        "http://www.thestudiotour.com/wp/wp-content/gallery/ush-backlot-colonial-munster/Screen-Shot-2012-03-19-at-23.54.38.png"
    }),
    Campus.create({
      name: "Xanadu",
      ...
      imgUrl:
        "http://www.scriptgodsmustdie.com/wp-content/uploads/2015/02/Xanadu-Gates-Citizen-Kane.png"
    })
  ]).then(campuses =>
    Promise.all(
      [...new Array(200)].map(() => {
        ...
        const campus = campuses[Math.floor(Math.random() * 4)] || null;
        if (campus) newStudent.campusId = campus.id;
